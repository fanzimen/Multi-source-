...
class Discriminator(nn.Module):
    ...
    def forward(self, input_feature, alpha):
        ...
        # input_dis = reversed_input.reshape(reversed_input.shape[0], 1, -1)
        # x = self.discriminator(input_dis)
...
class MFSAN(nn.Module):
    ...
    def forward(self, data_src, data_tgt = 0, label_src = 0, alpha = 1, mark = 1):
        ...
        if self.training == True:
            ...
            if mark == 1:#源域数据1
                ...
                return rul_loss, domain_loss, l1_loss / 2
